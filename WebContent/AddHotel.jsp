...
<div id="menu">
<ul class="circle">
	<marquee>Welcome <%= Name %></marquee>
</ul>
</div>
<form align="center" action="Add_Hotel_Servlet" method="post">
<table align="center">
<tr><td>Hotel Name::</td><td><input type="text" name="hotelname" required></td></tr>
<tr><td>Valid From::</td><td><input type="text" name="validfrom" required></td></tr>
<tr><td>Valid To::</td><td><input type="text" name="validto" required></td></tr>
