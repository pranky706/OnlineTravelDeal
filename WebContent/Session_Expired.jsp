...
<div id="menu">
<ul class="circle">
	<li ><a class="four"  href="Home.html">Home</a></li>
...
<h2 align="center">--::Session Expired::--</h2>
To go to Merchant login page<a align="center" href="Merchant_Login.html">Click here</a>
