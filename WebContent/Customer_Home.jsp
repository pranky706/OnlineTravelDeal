...
<ul class="circle">
	...
	<li style="text-align: center"><a href="CustomerServlet"><%= name %>'s Home</a></li>
	<li style="text-align: center"><a href="logoutServlet">Log Out</a></li>
  
</ul>
<br>
</div>
<table align="center">
	<tr><td>Deal Id:</td><td><%= da.getId() %></td></tr>
	<tr><td>Title:</td><td><%= da.getTitle() %></td></tr>
	<tr><td>Valid From:</td><td><%= da.getValidfrom() %></td></tr>
	<tr><td>Valid To:</td><td><%= da.getValidto() %></td></tr>
	<tr><td>Food Cost Per Person:</td><td><%= da.getFoodcast() %></td></tr>
	<tr><td>Lodge Cost Per Day:</td><td><%= da.getLodgecost() %></td></tr>
	<tr><td>Travel Cost Person:</td><td><%= da.getTranspotcost() %></td></tr>
	<tr><td>Salesman Email:</td><td><%= da.getSemail() %></td></tr>
	<tr><td>Merchant Email:</td><td><%= da.getMemail() %></td></tr>
	<form align="center" action="book_deal_servlet" method="post">
	<tr><td>Duration::</td><td><input type="text" name="du" required></td></tr>
	<tr><td>Date of Booking::</td><td><input type="text" name="da" required></td></tr>
	<tr><td>No of person::</td><td><input type="text" name="no" required></td></tr>
