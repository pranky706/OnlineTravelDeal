...
<ul class="circle">
	...
	<li style="text-align: center"><a href="ShowcustdealsServlet">Book A Deal</a></li>
	<li style="text-align: center"><a href="logoutServlet">Log Out</a></li>
</ul>
</div>
<h2 align="center">Welcome <%= Name %></h2>
<h3 align="center">Login time <%= time %></h2>
<%
	if(alist!=null)
	{
%>
...
<% }
	...
	{
%>
<h1 align="center">--::No Previous Booking ::--</h1>
<%} %>
<div id="footer">
